...
const greeting = () => async (ctx: Context) => {
  ...
  const responses: { [key: string]: ResponseType[] } = {
    ...
    "下午茶|點心": [
      ...
      { type: 'string', text: "今天下午茶是倒反天罡套餐~~" },
      { type: 'string', text: "有人要來一杯五桐號嗎~~" },
      { type: 'image', source: "https://cc.tvbs.com.tw/img/program/upload/2021/12/23/20211223155004-2a409f66.jpg" },//吐司
      { type: 'string', text: "今天請大家喝手搖,幫我點最便宜的無糖紅茶,thx" },
      { type: 'image', source: "https://i.imgur.com/vD727zv.jpeg" },//崩壞披薩
      { type: 'image', source: "https://i.imgur.com/n6K8ZdO.jpeg" }//漢堡王
    ],
    "飲料|口渴": [
      // { type: 'string', text: "飲料太貴,喝水就好" },
      // { type: 'string', text: "少無綠L,thx" },
      { type: 'string', text: "Lerry：少無綠L,thx\nLeo：恆為濾水濾不乾淨地下水 Ｌ無糖\n馬哥：只能看不能喝全脂鮮乳 XS 全糖\nQAQQ ：尊榮無限續杯 全糖奶蓋 公升杯 X1" }
    ],
    "髒|臭": [
      { type: 'string', text: "Grace去倒垃圾" },
      { type: 'string', text: "Grace去掃廁所" },
      { type: 'string', text: "廁所已拉封鎖線,敬請同仁見諒,thx" }
    ],
    "大便|馬桶|廁所|拉屎|拉粑粑": [
      { type: 'string', text: "馬桶上的尿垢再請Grace留意 齁齁" },
      { type: 'string', text: "我是廁所守門員 齁齁" },
      { type: 'string', text: `${userName}還滿意我掃的廁所嗎?` },
    ],
    "需求|緊急|做不完|快爆炸|炸|技術": [
    ...
    "社團|校外教學": [
      ...
      { type: 'image', source: "https://i.imgur.com/00DD2XA.jpeg" },//Sean單槓
      { type: 'image', source: "https://i.imgur.com/uVuxvfm.jpeg" },//公司披薩
    ...
    "值日生": [
      // { type: 'string', text: `今天的值日生是${getRandomName()}~~` },
      { type: 'string', text: `今天的值日生是我~~` }
    ],
    "開會|會議": [
      { type: 'string', text: "我Main開投影機" },
      { type: 'string', text: "該來會議室睡覺了" }
    ],
    "Gank": [
    ...
    "想睡|賽車": [
      ...
      { type: 'image', source: "https://i.imgur.com/ZmiQ73Y.jpeg" }//哀鳳阿罵
    ],
    // "阿罵|啊罵|阿嬤|啊嬤|iphone|哀鳳": [
    //   { type: 'image', source: "https://i.imgur.com/ZmiQ73Y.jpeg" },//哀鳳阿罵
    //   { type: 'string', text: "Leo都說:愛情小坦克，撞誰誰休克" }
    // ],
    "目標|團隊": [
      { type: 'string', text: "我們團隊就像f1賽車 後輪要裝在前輪上 輪胎要先洩氣,thx" }
    ],
    "贏": [
      { type: 'image', source: "https://i.imgur.com/VQsfguq.jpeg" }//Leo奪牌
    ],
    "薯條": [
    ...
    "累": [
      ...
      { type: 'image', source: "https://i.imgur.com/ATtdvU8.gif" },//貓跌倒
    ],
    "下課|四點": [
    ...
    "領導|主管|資方|管理|人事|員工": [
      ...
      { type: 'string', text: "魯哥 Kim 該來會議室睡覺了" },
      { type: 'image', source: "https://i.imgur.com/ATtdvU8.gif" },//貓跌倒
      { type: 'string', text: "我好渴望有一套大公司的人事管理系統" },
    ],
    "本群": [
    ...
    "考評|考績|自評表": [
      { type: 'string', text: "自評表請一律給自己C不能再高,thx" },
      { type: 'string', text: `自評表${userName}寫再高,我也不會多給你錢,thx` }
    ],
    "獎金|年終": [
      { type: 'image', source: "https://i.imgur.com/efLGupH.jpeg" },//金錢是帶來快樂的梗圖
      { type: 'string', text: "輪胎都裝不好還想領錢" }
    ],
    "abtest|ab test": [
      { type: 'string', text: "我在本公司提倡ABtest,結果只成QAtest" }
    ],
    "聚餐|餐聚": [
    ...
    "遠端": [
      ...
      { type: 'string', text: `我們應該要來推廣一下這個遠端連回去玩爐石的運動` }
    ],
    "打卡": [
    ...
    "捕魚": [
      { type: 'image', source: "https://i.imgur.com/KI7nE1b.gif" }//加班飛彈
    ],
    "加班": [
    ...
    "可以打排球嗎": [
      { type: 'string', text: `砸爛樓下大門我扛` }
    ],
    "怕": [
      { type: 'image', source: "https://i.imgur.com/BrA3Ug5.jpeg" },//怕爆
    ],
    "ok嗎?|可以嗎?": [
      { type: 'string', text: "1" }
    ],
...
const schedules = [
  ...
  // { hour: 10, minute: 0, second: 0, message: '(大家起立)' },
  // { hour: 10, minute: 5, second: 0, message: '今天這個天氣,我想給自己放個假,在家睡覺' },
  // { hour: 10, minute: 2, second: 30, message: `${getRandomName()}打卡了嗎?` },
  ...
  { hour: 10, minute: 38, second: 50, message: `Sean,晚点请过来一下会议室,thx` },
  // { hour: 13, minute: 35, second: 0, message: 'Apple幫我關燈我要睡覺thx' },
  ...
  // { hour: 16, minute: 1, second: 0, message: `${getRandomName()}四點了,放風啦~~` },
